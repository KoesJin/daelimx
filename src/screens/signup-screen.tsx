    ...
    return (
        <Container>
            ...
            <Form>
                ...
                <Input onChange={onChange} name="name" type="text" placeholder="예) Daelim" value={nickName} />
                ...
                <Input onChange={onChange} name="password" type="password" placeholder="*********" value={password} />
